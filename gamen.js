...
function mouseClick(e) {
 ...
 if (x < 750 && x > 30 && y > 180 & y < 540) {
  chakraS(x, y);
 }
 if (x < 750 && x > 30 && y > 180 & y < 540 && (b == 0)) {
  test(x, y);
  narutoPlay(sh, sh1);
 } else {
  ctxRaz.clearRect(190, 70, 100, 100);
  b = 1;
 }
 if (x < 750 && x > 30 && y > 180 & y < 540 && (bK == 0)) {
  test(x, y);
  kakashiPlay(sh, sh1)
 } else {
  ctxRaz.clearRect(190, 70, 100, 100);
 ...
 if (x < 750 && x > 30 && y > 180 & y < 540 && (bS == false)) {
  test(x, y);
  sasukePlay(sh, sh1);
 } else {
  ctxRaz.clearRect(190, 70, 100, 100);
 ...
 if (x < 750 && x > 30 && y > 180 & y < 540 && (bSc == false)) {
  test(x, y);
  sacuraPlay(sh, sh1);
 } else {
  ctxRaz.clearRect(190, 70, 100, 100);
 ...
 if (x < 750 && x > 30 && y > 180 & y < 540 && (bG == false)) {} else {
  ctxRaz.clearRect(190, 70, 100, 100);
  bG = true;
 }
 ...
 if ((x > 220) && (x < 280) && y > 90 && y < 140 && (b == 1)) {
  if (chakraMain > 100) {
   a = '#ffffff';
  } else a = '#A52A2A';
  icon.stroke(a);
  b = 0;
  ctxRaz.drawImage(razmetka, 0, 0, 800, 600, 0, 0, 800, 600);
 } else {
  ctxRaz.clearRect(190, 70, 100, 100);
  b = 1;
 }
 if (x > 300 && x < 360 && y > 90 && y < 140 && bK == 1) {
  if (chakraMain > 150) {
   a = '#ffffff';
  } else a = '#A52A2A';
  iconK.stroke(a);
  ...
  ctxRaz.clearRect(280, 70, 90, 100);
  bK = 1;
 }
 if ((x > 390) && (x < 450) && y > 90 && y < 140 && bS == true) {
  if (chakraMain > 150) {
   a = '#ffffff';
  } else a = '#A52A2A';
  iconS.stroke(a);
  ...
  ctxRaz.clearRect(360, 70, 100, 100);
  bS = true;
 }
 if ((x > 475) && (x < 535) && y > 90 && y < 140 && bSc == true) {
  if (chakraMain > 50) {
   a = '#ffffff';
  } else a = '#A52A2A';
  iconSk.stroke(a);
  ...
  ctxRaz.clearRect(450, 70, 90, 100);
  bSc = true;
 }
 if ((x > 565) && (x < 625) && y > 90 && y < 140 && bG == true) {
...
function chakraS(x, y) {
 for (var i = 0; i < chakraArray.length; i++) {
  ...
  if (x >= chakraArray[i].drawX && x <= chakraArray[i].drawX + chakraArray[i].width) {
   chakraArray[i].destroy();
   chakraMain = chakraMain + 25;
  }
 }
...
Naruto.prototype.update = function() {
 ...
 if (this.srcX < 350 && this.srcX > 250) {
  rasenganPlay(this.drawX, this.drawY);
 }

 if (this.srcX < 350) this.srcX += 72;
 else this.srcX = 350;
...
Sasuke.prototype.update = function() {
 if (this.srcX < 360 && this.srcX > 30) {
  katunPlay(this.drawX, this.drawY);
 }

 if (this.srcX < 350) this.srcX += 60;
 else this.srcX = 360;
...
Kakasi.prototype.update = function() {
 if (this.srcX < 1900 && this.srcX > 1700) {
  chedoriPlay(this.drawX, this.drawY);
 }

 if (this.srcX < 1800) this.srcX += 100;
 else this.srcX = 1900;
...
Sacura.prototype.update = function() {
 ...
 if (this.srcX < 500) this.srcX += 100;
 else this.srcX = 0;
...
Enemy.prototype.update = function() {
 if (this.srcX < 600) this.srcX += 100;
 else this.srcX = 0;
 this.drawX -= 10;

 for (var i = 0; i < rasenganArray.length; i++) {

  if (this.drawX >= rasenganArray[i].drawX && this.drawX <= rasenganArray[i].drawX + rasenganArray[i].width && this.drawY <= rasenganArray[i].drawY && this.drawY <= rasenganArray[i].drawY + rasenganArray[i].height) {
   this.destroy();
   rasenganArray[i].destroy();
   ddd = i;
   dead++;
  }
 }
 ...
 for (var i = 0; i < chedoriArray.length; i++) {
  ...
  if (this.drawX >= chedoriArray[i].drawX && this.drawX <= chedoriArray[i].drawX + chedoriArray[i].width && this.drawY - 10 <= chedoriArray[i].drawY && this.drawY <= chedoriArray[i].drawY + chedoriArray[i].height) {
   this.destroy();
   chedoriArray[i].destroy();
   ddd = i;
   dead++;
  }
 }
 ...
 for (var i = 0; i < katunArray.length; i++) {
  ...
  if (this.drawX >= katunArray[i].drawX && this.drawX <= katunArray[i].drawX + katunArray[i].width && this.drawY - 10 <= katunArray[i].drawY && this.drawY <= katunArray[i].drawY + katunArray[i].height) {
   this.destroy();
   katunArray[i].destroy();
   ddd = i;
   dead++;
  }
 }
...
function startCreatingChakra() {
 ...
 spawnInterval1 = setInterval(function() {
  ChakraPlay()
 }, spawnTime);
}
